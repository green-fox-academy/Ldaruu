...
//    for (int oneElement : notSoCrypticMessage) {  //Version numb1
//      out += map.get(oneElement);

    for (int i = 0; i < notSoCrypticMessage.length; i++) {  //Version numb2
      int num = notSoCrypticMessage[i];
      out += map.get(num);
    }
